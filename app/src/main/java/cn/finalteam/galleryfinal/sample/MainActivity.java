...
public class MainActivity extends AppCompatActivity {
    ...
    @BindView(R.id.rb_theme_cyan)
    RadioButton mRbThemeCyan;
    @BindView(R.id.rb_theme_orange)
    RadioButton mRbThemeOrange;
    @BindView(R.id.rb_theme_green)
    RadioButton mRbThemeGreen;
    @BindView(R.id.rb_theme_teal)
    RadioButton mRbThemeTeal;
    @BindView(R.id.rb_theme_custom)
    RadioButton mRbThemeCustom;
    @BindView(R.id.cb_crop_replace_source)
    CheckBox mCbCropReplaceSource;
    @BindView(R.id.cb_rotate_replace_source)
    CheckBox mCbRotateReplaceSource;
    @BindView(R.id.cb_open_force_crop)
    CheckBox mCbOpenForceCrop;
    @BindView(R.id.cb_open_force_crop_edit)
    CheckBox mCbOpenForceCropEdit;
    @BindView(R.id.ll_force_crop)
